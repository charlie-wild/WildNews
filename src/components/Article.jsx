...
class Article extends Component {
          ...
          <Fragment>
            <article className="article">
              ...
              {this.props.user.user_id === this.state.article.user_id && (
                <DeleteArticle article_id={this.state.article.article_id} />
              )}
              <em>
            ...
            <ul>
              {comments.length === 0 && (
                <p>Why not be the first to add a comment?</p>
              )}
  ...
  pagginate = () => {
    api
      .changeCommentPage(this.state.page, this.props.article_id)
